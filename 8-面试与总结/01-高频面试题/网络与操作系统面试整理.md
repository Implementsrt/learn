...
> 知识点：[TCP 三次握手](HTTP请求完整链路详解.md#三、tcp-三次握手) / [TCP 四次挥手](HTTP请求完整链路详解.md#八、tcp-四次挥手)

---

## Q2：HTTP 和 HTTPS 的区别？

> 知识点：[TLS 握手与 HTTPS 加密通道](HTTP请求完整链路详解.md#四、tls-握手-https-加密通道)
...
> 知识点：[HTTP 请求与响应报文](HTTP请求完整链路详解.md#五、http-请求-响应)
...
## Q4：Cookie、Session、Token 的区别？

> 知识点：[Token（JWT vs Opaque Token）](网络与操作系统面试整理.md#q5-token-jwt-vs-opaque-token)
...
## Q5：Token（JWT vs Opaque Token）

> 知识点：[Cookie、Session、Token 对比](网络与操作系统面试整理.md#q4-cookie、session、token-的区别)
