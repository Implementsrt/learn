...
- [Q1：分库分表后，跨分片分页和缺少分片键的查询怎么处理？](MySQL面试整理.md#q1-分库分表后-跨分片分页和缺少分片键的查询怎么处理)
- [Q2：为什么用 CDC/Canal 同步搜索索引，如何处理乱序、失败和重建？](MySQL面试整理.md#q2-为什么用-cdc-canal-同步搜索索引-如何处理乱序、失败和重建)

## 1. 索引为什么用 B+ 树？

> 知识点：[MySQL 索引详解](../../3-Java框架/04-ORM与数据访问/2026-06-25-MySQL索引详解.md)
...
> 知识点：[索引失效场景](MySQL面试整理.md#四十六、索引失效场景)
...
> 知识点：[事务隔离级别、幻读与 MVCC](MySQL面试整理.md#二十六、mysql-深入面试题)
...
> 知识点：[MySQL 锁机制](../../3-Java框架/04-ORM与数据访问/2026-06-25-MySQL锁机制.md)
...
> 知识点：[EXPLAIN 执行计划](../../3-Java框架/04-ORM与数据访问/2026-07-23-MySQL执行计划结果详解.md) / [慢 SQL 排查实践](../../99-业务场景实践题/2026-06-25-慢SQL排查与优化实践.md)
...
③ 避免索引失效（详见：[索引失效场景](MySQL面试整理.md#四十六、索引失效场景)）
```
...
> 知识点：[数据库主从与分片](../../3-Java框架/04-ORM与数据访问/2026-06-25-数据库主从与分片.md) / [深分页成本分析与解决方案](../../3-Java框架/04-ORM与数据访问/2026-08-12-深分页成本分析与解决方案.md)
...
> 知识点：[ES 订单搜索资源隔离方案](../../3-Java框架/05-常用中间件/2026-06-30-ES订单搜索资源隔离方案.md)
