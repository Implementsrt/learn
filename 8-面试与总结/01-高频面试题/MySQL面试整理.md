...
- [Q7：分库分表后，跨分片分页和缺少分片键的查询怎么处理？](MySQL面试整理.md#q7-分库分表后-跨分片分页和缺少分片键的查询怎么处理)
- [Q8：为什么用 CDC/Canal 同步搜索索引，如何处理乱序、失败和重建？](MySQL面试整理.md#q8-为什么用-cdc-canal-同步搜索索引-如何处理乱序、失败和重建)

## Q1：索引为什么用 B+ 树？

> 知识点：[MySQL 索引详解](../../3-Java框架/04-ORM与数据访问/2026-06-25-MySQL索引详解.md#q1-mysql-索引是什么-如何理解和设计索引)
...
> 知识点：[MySQL 索引详解](../../3-Java框架/04-ORM与数据访问/2026-06-25-MySQL索引详解.md#q2-为什么回表代价昂贵-二级索引天然包含的主键能否作为-where-条件使用)
...
> 知识点：[索引失效场景](../../3-Java框架/04-ORM与数据访问/2026-08-14-MySQL索引失效场景.md#q1-为什么联合索引会因为最左前缀、范围查询或函数而失效)
...
> 知识点：[事务隔离级别、幻读与 MVCC](../../3-Java框架/04-ORM与数据访问/2026-08-14-MySQL事务隔离与MVCC.md#q1-mysql-的事务隔离级别、readview-和-mvcc-如何配合)
...
> 知识点：[MySQL 锁机制](../../3-Java框架/04-ORM与数据访问/2026-06-25-MySQL锁机制.md#q1-mysql-中有哪些锁-它们分别解决什么问题)
...
> 知识点：[EXPLAIN 执行计划](../../3-Java框架/04-ORM与数据访问/2026-07-23-MySQL执行计划结果详解.md#q1-mysql-执行计划每个字段分别表示什么-如何结合示例分析) / [慢 SQL 排查实践](../../99-业务场景实践题/2026-06-25-慢SQL排查与优化实践.md#q1-业务场景实践题-如何排查慢-sql-并分析解决)
...
③ 避免索引失效（详见：[索引失效场景](../../3-Java框架/04-ORM与数据访问/2026-08-14-MySQL索引失效场景.md#q1-为什么联合索引会因为最左前缀、范围查询或函数而失效)）
```
...
## Q7：分库分表后，跨分片分页和缺少分片键的查询怎么处理？

> 知识点：[数据库主从与分片](../../3-Java框架/04-ORM与数据访问/2026-06-25-数据库主从与分片.md#q3-如何设计高频跨分片键查询-避免无脑全路由导致性能雪崩) / [深分页成本分析与解决方案](../../3-Java框架/04-ORM与数据访问/2026-08-12-深分页成本分析与解决方案.md#q1-深分页为什么成本高-如何分析并选择解决方案)
...
## Q8：为什么用 CDC/Canal 同步搜索索引，如何处理乱序、失败和重建？

> 知识点：[ES 订单搜索资源隔离方案](../../3-Java框架/05-常用中间件/2026-06-30-ES订单搜索资源隔离方案.md#q1-订单搜索共用-es-被其他业务影响时-独立集群、专用节点、独立索引和队列三种资源隔离方案如何取舍)
