...
> 知识点：[JVM 内存模型](../../1-Java基础/05-JVM原理与调优/2026-06-24-JVM内存模型.md#q1-说一下-jvm-内存模型)
...
> 知识点：[GC 过程](../../1-Java基础/05-JVM原理与调优/2026-06-24-GC过程.md#q1-说一下-gc-的过程)
...
> 知识点：[GC 收集器对比](../../1-Java基础/05-JVM原理与调优/2026-06-24-GC过程.md#q5-对比-gc-收集器-从-stw-等方面解释分析)
...
> 知识点：[GC Root](../../1-Java基础/05-JVM原理与调优/2026-06-24-GC过程.md#q2-gc-roots-为什么包含虚拟机栈中的局部变量引用-局部变量不是会随线程结束消亡吗)
...
> 知识点：[JVM 内存问题排查实践](../../99-业务场景实践题/2026-06-24-JVM内存问题排查实践.md#q1-详细说一下-jvm-内存问题排查思路-具体执行什么命令-执行命令后需要观察什么才能发现对应的问题)
...
> 知识点：[类加载机制](../../1-Java基础/05-JVM原理与调优/2026-06-24-类加载机制.md#q1-说一下类的加载)
